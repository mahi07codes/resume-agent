...
def display_analysis_results(analysis_result):
    ...
    st.markdown(
        '<div style="text-align: right; font-size: 0.8rem; color: #888; margin-bottom: 10px;">Powered by SKILL Agent </div>',
        unsafe_allow_html=True
    )
...
"""
        ...
        report_content += "\n---\nAnalysis provided by SKILL Agent"
    ...
    if st.button("Generate Interview Questions"):
        if generate_questions_func:
            with st.spinner("Generating personalized interview questions..."):
                ...
                download_content += "\n---\nQuestions generated by SKILL Agent"
